...
void detKeypointsAlt(vector<cv::KeyPoint> &keypoints, cv::Mat &img, string detectorType, bool bVis, bool bWait)
{
...
void detKeypointsHarris(vector<cv::KeyPoint> &keypoints, cv::Mat &img, bool bVis, bool bWait)
{
...
void detKeypointsShiTomasi(vector<cv::KeyPoint> &keypoints, cv::Mat &img, bool bVis, bool bWait)
{
